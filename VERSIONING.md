...
| APK artefakty | `mereni-v0.43.0-debug.apk`, `mereni-v0.43.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.43.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.43.0` |
| UI | zobrazení `v0.43.0` vedle názvu aplikace |
