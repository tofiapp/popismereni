...
| APK artefakty | `mereni-v0.39.0-debug.apk`, `mereni-v0.39.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.39.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.39.0` |
| UI | zobrazení `v0.39.0` vedle názvu aplikace |
