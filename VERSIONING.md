...
| Android `versionCode` | `MAJOR*105000 + MINOR*1000 + PATCH + 70000` → `115000` |
| APK artefakty | `mereni-v0.45.0-debug.apk`, `mereni-v0.45.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.45.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.45.0` |
| UI | zobrazení `v0.45.0` vedle názvu aplikace |
