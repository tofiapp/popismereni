...
| Místo | Forma |
|---|---|
| Android `versionName` | `0.49.0` |
| Android `versionCode` | `MAJOR*105000 + MINOR*1000 + PATCH + 70000` → `117000` |
| APK artefakty | `mereni-v0.49.0-debug.apk`, `mereni-v0.49.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.49.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.49.0` |
| UI | zobrazení `v0.49.0` vedle názvu aplikace |
...
```bash
adb install -r artifacts/mereni-v0.49.0-debug.apk
```
