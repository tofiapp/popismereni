...
| Místo | Forma |
|---|---|
| Android `versionName` | `0.44.0` |
| Android `versionCode` | `MAJOR*105000 + MINOR*1000 + PATCH + 70000` → `114000` |
| APK artefakty | `mereni-v0.44.0-debug.apk`, `mereni-v0.44.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.44.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.44.0` |
| UI | zobrazení `v0.44.0` vedle názvu aplikace |
