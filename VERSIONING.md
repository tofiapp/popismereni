...
| Android `versionCode` | `MAJOR*10000 + MINOR*400 + PATCH` → `400` |
| APK artefakty | `mereni-v0.4.0-debug.apk`, `mereni-v0.4.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.4.0.json` |
| Exportní skript | `tools/export_pasport_v0.4.0.py` |
| Git tag / GitHub Release | `v0.4.0` |
| UI | zobrazení `v0.4.0` vedle názvu aplikace |
