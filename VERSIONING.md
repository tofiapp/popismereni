...
| Android `versionCode` | `MAJOR*100000 + MINOR*1000 + PATCH + 70000` → `91000` |
| APK artefakty | `mereni-v0.21.0-debug.apk`, `mereni-v0.21.0-release-unsigned.apk` |
| Pasport JSON v assets | `pasport_tpi_v0.21.0.json` (nebo nejbližší dostupný fallback) |
| Git tag / GitHub Release | `v0.21.0` |
| UI | zobrazení `v0.21.0` vedle názvu aplikace |
...
```bash
adb install -r artifacts/mereni-v0.21.0-debug.apk
```
